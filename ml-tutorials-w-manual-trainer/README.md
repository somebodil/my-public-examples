...
* Use PyCharm, and open project from this level.
* When running via cmd, add this root path to PYTHONPATH (ex. PYTHONPATH=$(pwd) python word2vec-skipgram-naive-softmax-version/main.py)
```
